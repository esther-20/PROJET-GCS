        ...
        <div class="card-body">
           ...
           <form method="POST" action="assets/php/add_projet_produit.php">
               ...
               <div class="form-group form-float">
                 ...
                 <!-- name = qte cmdeé -->
                <div class="form-group form-float" >
                    <label for="input-2">Quantite commandee</label>
                    <input type="number" name="quantite_produit_cmdee" min="0" class="form-control" required id="input-2" placeholder="Quantite commandee">
                </div>


                  <!-- name = qte -->
                <div class="form-group form-float" >
                    <label for="input-2">Quantite livree</label>
                    <input type="number" name="quantite_produit" min="0" class="form-control" required id="input-2" placeholder="Quantite livree">
                </div>
