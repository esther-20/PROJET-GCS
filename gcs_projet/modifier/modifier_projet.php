...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        <div class="card">
        <div class="card-header">Projet-> Modification
        ...
        <div class="card-body">
            ...
            <form method="POST" action="../assets/php/up_projet.php">
                    <!-- name = libelle  -->
               <div class="form-group" >
                    ...
                    $query_projet= "SELECT * FROM projet p INNER JOIN utilisateur u ON p.id_utilisateur = u.id_utilisateur WHERE p.id_projet =:id";
                    $query_prepare=$pdo->prepare($query_projet);
                    $query_prepare->execute(array(':id'=>$id));
                    $projet=$query_prepare->fetch();
                    
                    echo "<input type='text' name='nom_projet' value='$projet[nom_projet]' class='form-control' id='input-1' required>";
                ...
                <div class="form-group" >
                   ...
                   <?php echo $date_projet["date_projet"] ; ?>
                    <?php
/*
                    $id = $_GET['id_projet'];

                    $query_produit= "SELECT * FROM projet p INNER JOIN utilisateur u ON p.id_utilisateur = u.id_utilisateur WHERE p.id_projet =:id";
                    $query_prepare=$pdo->prepare($query_projet);
                    $query_prepare->execute(array(':id'=>$id));
                    $projet=$query_prepare->fetch();*/
                    
                    echo "<input type='text' name='date_projet' value='$projet[date_projet]' class='form-control' id='input-1' required>";
              ...
              <select class="form-control" name="id_utilisateur" required="required">
                ...
                <!--<div class="form-group" >
                    ...
                    <!-- name =  -->
                <div class="form-group">
                    <button type="submit" name="upprojet" class="btn btn-info px-5 btn-block">Modifier</button>
                </div>
