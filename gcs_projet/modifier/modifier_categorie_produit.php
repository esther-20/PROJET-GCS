...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        <div class="card">
        <div class="card-header">Categorie produit -> Modiffication
        ...
        <div class="card-body">
           ...
           <form method="POST" action="../assets/php/up_categorie_produit.php">
                    <!-- name =  -->
               <div class="form-group" >
                  ...
                  <?php
                    ...
                    $query_categorie = "SELECT * FROM categorie_produit WHERE id_categorie_produit =:id";
                    $query_prepare=$pdo->prepare($query_categorie);
                    $query_prepare->execute(array(':id'=>$id));
                    $categorie=$query_prepare->fetch();

                    echo "<input type='text' name='libelle_categorie_produit' value='$categorie[libelle_categorie_produit]' class='form-control' id='input-1' required>";
                    ...
                    <!-- name =  -->
                <div class="form-group">
                    <button type="submit" name="upcategorieproduit" class="btn btn-info px-5 btn-block">Modifier</button>
                </div>
            </form>
