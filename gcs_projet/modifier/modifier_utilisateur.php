...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        <div class="card">
        <div class="card-header">utilisateur -> Modification
        ...
        <div class="card-body">
            ...
            <form method="POST" action="../assets/php/up_utilisateur.php">
                     <!-- name = name  -->
               <div class="form-group" >
                    ...
                    $query_produit= "SELECT * FROM utilisateur u INNER JOIN typutilisateur t ON u.id_typutilisateur = t.typutilisateur WHERE u.id_utilisateur =:id";
                    $query_prepare=$pdo->prepare($query_utilisateur);
                    $query_prepare->execute(array(':id'=>$id));
                    $utilisateur=$query_prepare->fetch();
                  
                    echo "<input type='text' name='nom_utilisateur' value='$utilisateur[nom_utilisateur]' class='form-control' id='input-1' required>";
                ...
                <div class="form-group">
                    <label for="input-2">Prénoms</label>
                     <?php 
                    echo "<input type='text' name='prenom_utilisateur' value='$utilisateur[prenom_utilisateur]' class='form-control' id='input-2' required>";
                ...
                <div class="form-group">
                    <label for="input-3">Email</label>
                     <?php 
                    echo "<input type='text' name='email_utilisateur' value='$utilisateur[email_utilisateur]' class='form-control' id='input-3' required>";
                ...
                <div class="form-group">
                    <label for="input-4">Telephone</label>
                     <?php 
                    echo "<input type='text' name='tel_utilisateur' value='$utilisateur[tel_utilisateur]' class='form-control' id='input-4' required>";
                    ...
                    <div class="form-group">
                        <label for="input-4">Mot de passe</label>
                         <?php 
                    echo "<input type='password' name='motpass_utilisateur' value='$utilisateur[motpass_utilisateur]' class='form-control' id='input-1' required>";
                  ...
                  <select class="form-control" required="" name="id_typutilisateur">
                    ...
                    <!-- name = valider  -->
                <div class="form-group">
                    <button type="submit" name="uputilisateur" class="btn btn-info px-5 btn-block">Modifier</button>
                </div>
            </form>
        </div>
        </div>
