...
<div class="card">
  ...
  echo "<tr>";
  echo "<td><p class='c_name'>".$row_projet['nom_projet']."</p></td>";
  ...
  echo "<td><a class='btn btn-info' href='modifier/modifier_projet.php?id_projet=$row_projet[id_projet]'>Modifier</a> <a class='btn btn-danger' href='delete/delete_projet.php?id_projet=$row_projet[id_projet]\" onClick=\"return confirm('Voulez-vous vraiment supprimer cet projet ?')\'>Supprimer</a></td>";
  echo "</tr>";
...
<div class="row m-3">
  ...
  <div class="col-3">
    <h4 class="text-left">Ajout des projets et produits</h4>  
  </div>
