      ...
      <tbody>
         ...
         <?php 
            ...
            while ($row_projet=$statement_projet->fetch()) 
            {
                        ...
                        echo "<td><a class='btn btn-info'>Modifier</a> <a class='btn btn-danger' href='delete/delete_projet.php?id_projet=$row_projet[id_projet]\" onClick=\"return confirm('Voulez-vous vraiment supprimer cet projet ?')\'>Supprimer</a></td>";
                          //echo"<td>  </td>";
                          echo "</tr>";
