...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        ...
        <div class="card-body">
           ...
           <form method="POST" action="assets/php/add_projet_produits.php">
               ...
               <div class="form-group form-float">
                  <label for="Categorie_produit">Categorie_produits</label>
                    <select class="form-control" required="" name="id_Categorie_produit">
                      <?php
                                while($row_categorie_produit=$categorie_produit->fetch())
                                     {
              ...
              <!-- name = id_utilisateur -->
                ...
                <div class="form-group form-float">
                  <label for="utilisateur">Statut</label>
                  <select class="form-control" required=" required" name="statut_produit" >
                  <option>Livre</option>  
