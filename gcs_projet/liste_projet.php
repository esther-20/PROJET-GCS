...
<div class="row m-3">
  ...
  <div class="col-3">
    <h4 class="text-left">Liste projet</h4>  
  </div>
...
<div class="card">
  <div class="card-header">Liste projet </div>
    ...
    while ($row_appartenir=$statement_appartenir->fetch()) 
            {
                        ...
                        echo "<td><p class='c_name'>".$row_appartenir['quantite_produit']."</p></td>";
                        echo "<td><p class='c_name'>".$row_appartenir['statut_produit']."</p></td>";
                        echo "<td> <a class='btn btn-info'>Modifier</a> <a class='btn btn-danger'data-toggle='modal' data-target='#exampleModal'>Supprimer</a></td>";
                        echo"<td>  </td>";
                        echo "</tr>";
